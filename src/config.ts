...
export const PROVIDER_PRESETS: Record<string, ProviderPresetConfig> = {
  ...
  x666: {
    ...
    apiKeyEnv: 'X666_API_KEY',
    defaultModel: 'deepseek-v4-pro',
    authHeader: 'Bearer ${apiKey}',
    supportsVision: false,
    supportsToolCalling: true,
    models: [
      { id: 'deepseek-v4-pro', label: 'DeepSeek V4 Pro — 聊天首选，快且自然' },
      { id: 'deepseek-v4-flash', label: 'DeepSeek V4 Flash — 更快更轻' },
      { id: 'grok-4.20-fast', label: 'Grok 4.20 Fast — 陪伴聊天' },
      { id: 'grok-4.3-high', label: 'Grok 4.3 High — 深度情绪' },
      { id: 'gemini-2.5-pro-1m', label: 'Gemini 2.5 Pro 1M — 长上下文' },
