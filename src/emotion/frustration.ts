...
import type { AttachmentStyle, AffinityState, MultiAxisState } from '../types.js';
...
import { frustrationStatePath } from '../memory/paths.js';
...
function persist(): void {
  try {
    writeFileSyncSafe(frustrationStatePath(), JSON.stringify(state, null, 2));
  } catch {
